...
public class employee_infoService {
    ...
    @Transactional public String save_Emp(final employee_infoRequestDto params)throws Exception {
    ...
    public List<employee_infoResponseDto> findAll_Emp()throws Exception {
        ...
        return list
            .stream()
            .map(employee_infoResponseDto::new)
    ...
    public String update_Emp(final String id, final employee_infoRequestDto params)throws Exception {
        ...
        employee_info entity = employee_inforepository
            .findById(id)
            .orElse(null);
        entity.update(
            params.getCompany(),
